...
@JsonSerializable()
class RegisterPassengerRequestModel
    extends RegisterPassengerRequest {
  ...
  factory RegisterPassengerRequestModel.fromJson(
    Map<String, dynamic> json,
  ) =>
      _$RegisterPassengerRequestModelFromJson(json);

  Map<String, dynamic> toJson() =>
      _$RegisterPassengerRequestModelToJson(this);
}
